...
public:
	...
	double buy_stock(string, double, double);				//enter the share symbol and the number of share to be bought
	double sell_stock(string, double, double);
	...
	void bubble_sort();
	void selection_sort();
	CString print_out_history_stock();
